...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "amendment_joint_to_sole", name = "Amendment_joint_to_sole", hidden = true)
@ProcessInput(processName = "amendment_joint_to_sole")
public class Amendment_joint_to_soleModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<Amendment_joint_to_soleModel> {
    ...
    @Override()
    public Amendment_joint_to_soleModel toModel() {
        Amendment_joint_to_soleModel result = new Amendment_joint_to_soleModel();
