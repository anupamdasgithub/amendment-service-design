...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "amendment_coa", name = "Amendment_coa", hidden = false)
public class Amendment_coaModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Amendment_coaModelOutput> {
    ...
    @Override()
    public Amendment_coaModelOutput toModel() {
        Amendment_coaModelOutput result = new Amendment_coaModelOutput();
        result.setId(getId());
