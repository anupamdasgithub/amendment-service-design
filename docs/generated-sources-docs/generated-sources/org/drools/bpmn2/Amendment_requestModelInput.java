...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "amendment_request", name = "Amendment_request", hidden = true)
@ProcessInput(processName = "amendment_request")
public class Amendment_requestModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<Amendment_requestModel> {
    ...
    @Override()
    public Amendment_requestModel toModel() {
        Amendment_requestModel result = new Amendment_requestModel();
        result.setRequest(getRequest());
        result.setAmendmentItems(getAmendmentItems());
        result.setItemType(getItemType());
        result.setIncludesCon(getIncludesCon());
        ...
        result.setAccountStatus(getAccountStatus());
        result.setRiskBand(getRiskBand());
        result.setNameChangeReason(getNameChangeReason());
        result.setRequestId(getRequestId());
        result.setInFlightAmendment(getInFlightAmendment());
        result.setIsCoa(getIsCoa());
        result.setRequestorIsParty(getRequestorIsParty());
        result.setRemainingPartyEligible(getRemainingPartyEligible());
        result.setAddressVerified(getAddressVerified());
        result.setIncludesCoa(getIncludesCoa());
        result.setMandatePermits(getMandatePermits());
        result.setAmendmentType(getAmendmentType());
        result.setIncludesJointToSole(getIncludesJointToSole());
        result.setRescreenOutcome(getRescreenOutcome());
        result.setJointLiabilities(getJointLiabilities());
        result.setScreeningOutcome(getScreeningOutcome());
        result.setPermittedCount(getPermittedCount());
        result.setOtherPartyStatus(getOtherPartyStatus());
        result.setAccountIsJoint(getAccountIsJoint());
