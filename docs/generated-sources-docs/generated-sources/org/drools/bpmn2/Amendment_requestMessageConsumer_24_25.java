...
public class Amendment_requestMessageConsumer_24_25 extends SpringMessageConsumer<Amendment_requestModel, String> {
    ...
    @PostConstruct
    void init() {
        init(process, "AdditionalVerificationRequired", String.class, eventReceiver);
    }
