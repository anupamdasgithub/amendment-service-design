...
public class Amendment_requestMessageConsumer_18_19 extends SpringMessageConsumer<Amendment_requestModel, String> {
    ...
    @PostConstruct
    void init() {
        init(process, "ExtraDocumentSubmitted", String.class, eventReceiver);
    }
